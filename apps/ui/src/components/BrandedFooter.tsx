        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/signup?plan=free" className="text-sm text-gray-600 hover:text-blue-600 transition">
                  Start Free
                </Link>
              </li>
              <li>
                <Link to="/signup?plan=trial" className="text-sm text-gray-600 hover:text-blue-600 transition">
                  Free Trial
                </Link>
              </li>
              <li>
